...
//    Type
    ...
    public Todo(TodoRequest todoRequest) {
        ...
        // Convert String -> Date (if not null)
        if (todoRequest.getCompletionDate() != null) {
            this.completionDate = Date.valueOf(todoRequest.getCompletionDate());
        }

        // Convert String -> Enum (if not null)
        if (todoRequest.getNotifyMe() != null) {
            this.notifyMe = NotifyMe.valueOf(todoRequest.getNotifyMe());
        }
